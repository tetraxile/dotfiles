...
require('lazy').setup({
  ...
  -- add git related signs to sign column
  {
...
-- TODO: check for other good options?
...
vim.g.alternateExtension_h = "cpp,c,cxx,cc,CC"
vim.g.alternateExtension_H = "CPP,C,CXX,CC"
...
vim.keymap.set('n', '<leader>x', require('hex').toggle, { desc = "toggle hex" })
